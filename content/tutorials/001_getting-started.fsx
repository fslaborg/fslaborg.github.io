...
let h1 = 
    ...
    |> Chart.withX_AxisStyle("price distribution")(* output: 
<div id="998d4c7e-073f-4673-b2a8-4be3e2c6a26b" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_998d4c7e073f4673b2a84be3e2c6a26b = function() {
            ...
            var layout = {"xaxis":{"title":"price distribution"}};
            var config = {};
            Plotly.newPlot('998d4c7e-073f-4673-b2a8-4be3e2c6a26b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_998d4c7e073f4673b2a84be3e2c6a26b();
                };
...
let h2 =     
    ...
    |> Chart.Combine
    |> Chart.withX_AxisStyle("median value of owner occupied homes in 1000s")
    |> Chart.withX_AxisStyle("Comparison of price distributions")(* output: 
<div id="5cd35658-9e2b-43c7-acc4-a37b6fdd9973" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_5cd356589e2b43c7acc4a37b6fdd9973 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {"xaxis":{"title":"Comparison of price distributions"}};
            var config = {};
            Plotly.newPlot('5cd35658-9e2b-43c7-acc4-a37b6fdd9973', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_5cd356589e2b43c7acc4a37b6fdd9973();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_bba051e20d094ada93d3af8c4282bbb0();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
