...
<div id="d733bf2b-8432-44c1-9ee8-2d037b7e59e2" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d733bf2b843244c19ee82d037b7e59e2 = function() {
            ...
            var layout = {"xaxis":{"title":{"text":"price distribution"}}};
            var config = {};
            Plotly.newPlot('d733bf2b-8432-44c1-9ee8-2d037b7e59e2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d733bf2b843244c19ee82d037b7e59e2();
                };
...
<div id="270532b0-5de7-4ac1-86ec-877431fa25f3" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_270532b05de74ac186ec877431fa25f3 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {"xaxis":{"title":{"text":"Comparison of price distributions"}}};
            var config = {};
            Plotly.newPlot('270532b0-5de7-4ac1-86ec-877431fa25f3', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_270532b05de74ac186ec877431fa25f3();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_543582270a474a9d9d0573973bec9000();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
