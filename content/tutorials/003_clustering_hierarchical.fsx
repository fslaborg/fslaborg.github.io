...
<div id="c08d9f51-b6b4-4518-a3e9-aecd7ba50f29" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c08d9f51b6b44518a3e9aecd7ba50f29 = function() {
            ...
            var config = {};
            Plotly.newPlot('c08d9f51-b6b4-4518-a3e9-aecd7ba50f29', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c08d9f51b6b44518a3e9aecd7ba50f29();
                };
...
<div id="e862bd55-8004-426a-9d2f-d18c1fc8891b" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e862bd558004426a9d2fd18c1fc8891b = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('e862bd55-8004-426a-9d2f-d18c1fc8891b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_e862bd558004426a9d2fd18c1fc8891b();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
