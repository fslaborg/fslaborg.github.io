...
<div id="01a3b375-76b7-47b5-b6a5-dc2a5c2aecf8"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_01a3b37576b747b5b6a5dc2a5c2aecf8 = function() {
            ...
            Plotly.newPlot('01a3b375-76b7-47b5-b6a5-dc2a5c2aecf8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_01a3b37576b747b5b6a5dc2a5c2aecf8();
                };
...
<div id="2aa0dcd0-97ed-43af-a3fb-c5e6b0048570"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2aa0dcd097ed43afa3fbc5e6b0048570 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('2aa0dcd0-97ed-43af-a3fb-c5e6b0048570', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_2aa0dcd097ed43afa3fbc5e6b0048570();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
