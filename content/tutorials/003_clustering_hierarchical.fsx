...
<div id="6d7f44eb-1d14-4943-8815-efc7e53ef54e" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_6d7f44eb1d1449438815efc7e53ef54e = function() {
            ...
            var config = {};
            Plotly.newPlot('6d7f44eb-1d14-4943-8815-efc7e53ef54e', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_6d7f44eb1d1449438815efc7e53ef54e();
                };
...
<div id="9a8a0057-6fff-499f-9883-4c777e133cfe" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_9a8a00576fff499f98834c777e133cfe = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('9a8a0057-6fff-499f-9883-4c777e133cfe', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_9a8a00576fff499f98834c777e133cfe();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
