...
<div id="4ef01d44-53c1-4071-96a2-ee571d9428aa" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4ef01d4453c1407196a2ee571d9428aa = function() {
            ...
            var config = {};
            Plotly.newPlot('4ef01d44-53c1-4071-96a2-ee571d9428aa', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_4ef01d4453c1407196a2ee571d9428aa();
                };
...
<div id="68d68106-5fc2-4bda-9c03-a70422d5b133" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_68d681065fc24bda9c03a70422d5b133 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('68d68106-5fc2-4bda-9c03-a70422d5b133', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_68d681065fc24bda9c03a70422d5b133();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
