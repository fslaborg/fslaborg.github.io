...
<div id="f5b2eccc-f60d-4425-ba1c-d5bc3a382334" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f5b2ecccf60d4425ba1cd5bc3a382334 = function() {
            ...
            var config = {};
            Plotly.newPlot('f5b2eccc-f60d-4425-ba1c-d5bc3a382334', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f5b2ecccf60d4425ba1cd5bc3a382334();
                };
...
<div id="470eaced-6735-4c59-87ea-958b86b5a27c" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_470eaced67354c5987ea958b86b5a27c = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var layout = {"margin":{"l":100.0},"title":{"text":"Clustered iris data (hierarchical clustering)"}};
            var config = {};
            Plotly.newPlot('470eaced-6735-4c59-87ea-958b86b5a27c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_470eaced67354c5987ea958b86b5a27c();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
