...
<div id="d3dfeda6-86cc-4b66-a9b6-1517b08ce396" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d3dfeda686cc4b66a9b61517b08ce396 = function() {
            ...
            var config = {};
            Plotly.newPlot('d3dfeda6-86cc-4b66-a9b6-1517b08ce396', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d3dfeda686cc4b66a9b61517b08ce396();
                };
...
<div id="f29410e1-51e6-4c83-8373-bc1ebca3aca8" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f29410e151e64c838373bc1ebca3aca8 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.4.2.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('f29410e1-51e6-4c83-8373-bc1ebca3aca8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_f29410e151e64c838373bc1ebca3aca8();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
