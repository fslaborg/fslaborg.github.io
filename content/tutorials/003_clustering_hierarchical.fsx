...
<div id="32c79a5c-4708-471f-abc0-a8f2a55854ec" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_32c79a5c4708471fabc0a8f2a55854ec = function() {
            ...
            var config = {};
            Plotly.newPlot('32c79a5c-4708-471f-abc0-a8f2a55854ec', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_32c79a5c4708471fabc0a8f2a55854ec();
                };
...
<div id="40d5b5e3-d675-4891-a6b8-4ccd8fdb0509" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_40d5b5e3d6754891a6b84ccd8fdb0509 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('40d5b5e3-d675-4891-a6b8-4ccd8fdb0509', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_40d5b5e3d6754891a6b84ccd8fdb0509();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
