...
<div id="3f820305-f5f2-4611-9cc0-8d45e9c6a18d"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_3f820305f5f246119cc08d45e9c6a18d = function() {
            ...
            Plotly.newPlot('3f820305-f5f2-4611-9cc0-8d45e9c6a18d', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_3f820305f5f246119cc08d45e9c6a18d();
                };
...
<div id="c3d58114-6206-4307-b6e1-4af7958d5ec5"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c3d5811462064307b6e14af7958d5ec5 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('c3d58114-6206-4307-b6e1-4af7958d5ec5', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_c3d5811462064307b6e14af7958d5ec5();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
