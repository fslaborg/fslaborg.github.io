...
<div id="4b28ee0f-496a-4f8a-a6f4-c2338dbde045" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4b28ee0f496a4f8aa6f4c2338dbde045 = function() {
            ...
            var config = {};
            Plotly.newPlot('4b28ee0f-496a-4f8a-a6f4-c2338dbde045', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_4b28ee0f496a4f8aa6f4c2338dbde045();
                };
...
<div id="6df0a92e-a488-4a07-8c3b-1bd897a28265" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_6df0a92ea4884a078c3b1bd897a28265 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('6df0a92e-a488-4a07-8c3b-1bd897a28265', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_6df0a92ea4884a078c3b1bd897a28265();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
