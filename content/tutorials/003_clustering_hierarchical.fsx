...
<div id="f8237fdb-e6d4-44b4-b502-d3aa5ab988b8" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_f8237fdbe6d444b4b502d3aa5ab988b8 = function() {
            ...
            var config = {};
            Plotly.newPlot('f8237fdb-e6d4-44b4-b502-d3aa5ab988b8', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_f8237fdbe6d444b4b502d3aa5ab988b8();
                };
...
<div id="a2e0cb43-dfa4-4a5b-9c8f-7de311900c02" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a2e0cb43dfa44a5b9c8f7de311900c02 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {};
            Plotly.newPlot('a2e0cb43-dfa4-4a5b-9c8f-7de311900c02', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a2e0cb43dfa44a5b9c8f7de311900c02();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
