...
<div id="b81947ae-2b6f-4e76-978a-9f21a00bfd95" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_b81947ae2b6f4e76978a9f21a00bfd95 = function() {
            ...
            var config = {};
            Plotly.newPlot('b81947ae-2b6f-4e76-978a-9f21a00bfd95', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_b81947ae2b6f4e76978a9f21a00bfd95();
                };
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_6415d1a00f01477a9c28bab3ffde6d34();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            var config = {};
            Plotly.newPlot('e33be79e-3f52-47ee-9dc2-a0b64703cb6b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_e33be79e3f5247ee9dc2a0b64703cb6b();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="4e1c484c-64f3-423f-b8ab-b591b3c1c3bf" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_4e1c484c64f3423fb8abb591b3c1c3bf = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {

            var data = [{"type":"scatter","x":[2,3,4,5,6,7,8,9,10],"y":[2.6540379473960134,1.1455382767326712,0.36193008709138313,0.3275832723887103,0.17374735633037713,0.11853561254450393,0.11688566995916064,0.09420425993177053,0.0704781878089902],"mode":"lines","line":{},"marker":{},"error_y":{"array":[0.0,0.9350860709749945,0.12998002678800358,0.15315834889410943,0.0336848404150559,0.020857460295574965,0.035206285267090354,0.022052335731542347,0.017031409690455072]}}];
            var layout = {"xaxis":{"title":"k"},"yaxis":{"title":"average dispersion"},"title":"iris data set average dispersion per k"};
            var config = {};
            Plotly.newPlot('4e1c484c-64f3-423f-b8ab-b591b3c1c3bf', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_4e1c484c64f3423fb8abb591b3c1c3bf();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
