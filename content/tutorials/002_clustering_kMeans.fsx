...
<div id="3f47c243-9e55-495b-a8b4-74faea1a47aa" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_3f47c2439e55495ba8b474faea1a47aa = function() {
            ...
            var config = {};
            Plotly.newPlot('3f47c243-9e55-495b-a8b4-74faea1a47aa', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_3f47c2439e55495ba8b474faea1a47aa();
                };
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a8300edaa62e4553a18995fa3fa7ffcd();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            var config = {};
            Plotly.newPlot('5c9dcb3b-a526-472c-86c1-2f9a86b59d3c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_5c9dcb3ba526472c86c12f9a86b59d3c();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="672c3bb2-4b71-4297-b212-a450da2226f5" style="width: 600px; height: 600px;"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_672c3bb24b714297b212a450da2226f5 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-latest.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {

            var data = [{"type":"scatter","x":[2,3,4,5,6,7,8,9,10],"y":[2.6540379473960134,1.1319080031475128,0.39371204164564344,0.19458930065003494,0.19737113623040098,0.1477166552639867,0.10540005927314636,0.09545641798858027,0.08296789785233874],"mode":"lines","line":{},"marker":{},"error_y":{"array":[0.0,0.9135907619771416,0.1253337233861084,0.025929914227931748,0.10939670208167958,0.04065264871292715,0.04511009453804212,0.015462359669880242,0.020588032418798387]}}];
            var layout = {"xaxis":{"title":"k"},"yaxis":{"title":"average dispersion"},"title":"iris data set average dispersion per k"};
            var config = {};
            Plotly.newPlot('672c3bb2-4b71-4297-b212-a450da2226f5', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_672c3bb24b714297b212a450da2226f5();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
